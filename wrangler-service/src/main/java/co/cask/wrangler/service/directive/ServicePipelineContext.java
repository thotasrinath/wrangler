 ...
 */
public class ServicePipelineContext implements ExecutorContext {
  ...
  public ServicePipelineContext(Environment environment, HttpServiceContext serviceContext, TransientStore store) {
